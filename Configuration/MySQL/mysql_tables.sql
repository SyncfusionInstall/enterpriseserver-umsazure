...
PortNo int not null,
ActiveDirectoryNewUserLogin tinyint(1),
IsActive tinyint(1) not null,
	PRIMARY KEY (Id))
;
...
CREATE INDEX IX_User_UserName ON {database_name}.SfUMS_User (UserName)
;

CREATE INDEX IX_User_Email ON {database_name}.SfUMS_User (Email)
;

CREATE INDEX IX_User_DisplayName ON {database_name}.SfUMS_User (DisplayName)
;
